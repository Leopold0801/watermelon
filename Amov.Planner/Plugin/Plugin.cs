...
namespace Amov.Planner.Plugin
{
    ...
    public class PluginHost
    {
        ...
        /// Device change event
        /// </summary>
        public event Amov.Planner.AmovPlanner.WMDeviceChangeEventHandler DeviceChanged;

        internal void ProcessDeviceChanged(Amov.Planner.AmovPlanner.WM_DEVICECHANGE_enum dc)
        {
        ...
        {
            get { return Amov.Planner.AmovPlanner.dv1.comPort.MAV.cs; }
        }
        ...
        {
            get { return Amov.Planner.AmovPlanner.dv1.comPort; }
        }
        ...
        {
            get { return Amov.Planner.AmovPlanner.instance.FlightPlanner.contextMenuStrip1; }
        }
        ...
        public GMapPolygon FPDrawnPolygon
        {
            get
            {
                return new GMapPolygon(new List<PointLatLng>(AmovPlanner.instance.FlightPlanner.drawnpolygon.Points),
                    "Poly Copy")
                { Stroke = AmovPlanner.instance.FlightPlanner.drawnpolygon.Stroke };
            }
        }
